...
// All job hits 
let length = jobData.hits.length;
...
//Benefit of first job hits
for (i = 0; i <3; i++){
    let objString = JSON.stringify(jobData.hits[0].benefits[i], null, " ").replace(/"|{|}|,|/gi, '');
    console.log(objString);
}   
console.log('=============================================================================================');

//First job hits benefits value
bnflength = jobData.hits[0].benefits.length;
console.log(`First job Benefits:\n`)
for (i = 0 ; i < bnflength ; i++){
    console.log(`-${jobData.hits[0].benefits[i].benefitValue}`);
}
console.log('=============================================================================================');

// jobTitle and benefit value
for (let i = 0 ; i < length ; i++){
    console.log(jobData.hits[i].jobTitle);
    bnflength = jobData.hits[i].benefits.length;
    for (j = 0 ; j < bnflength ; j++){
...
//jobTitle/ locations/ skills/ jobsalary
for (let i = 0 ; i < length ; i++){
    console.log(jobData.hits[i].jobTitle);
    console.log('Salary: ' +jobData.hits[i].jobSalary);
    console.log('Location: ' +jobData.hits[i].locations.join());
    console.log('Skills:\n-' +jobData.hits[i].skills.join(`\n-`));
    console.log('-----------------------------------------');
}
